...
1. Bash 与 sh 兼容，现在使用的Linux就是使用Bash作为用户的基本Shell。
...
- 是否显示此欢迎信息，由ssh的配置文件/etc/ssh/sshd_config决定，加入“Banner/etc/issue.net”行才能显示（记得重启sshd服务）
